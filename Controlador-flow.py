...
class CombinedController(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None):
        ...
        # Incrementar el contador de flujos después de enviar el mensaje
        self.flow_counter[dpid] += 1
        self.logger.info(f"Flujo instalado en switch {dpid}. Total de flujos: {self.flow_counter[dpid]}")
    ...
    def _packet_in_handler(self, ev):
        ...
        # Definir el puerto de salida y detectar uso de flood
        ...
        # Instalar flujos solo si no se usa flood
