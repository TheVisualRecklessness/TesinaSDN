...
class CombinedController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mac_to_port = {}
        self.flow_counter = defaultdict(int)  # Contador de flujos por switch
        self.max_flows = 100  # Límite máximo de flujos por switch
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None):
        ...
        # Comprobar el límite de flujos
        if self.flow_counter[datapath.id] >= self.max_flows:
            self.logger.warning(f"Límite de flujos alcanzado en switch {datapath.id}. No se instalarán más flujos.")
            return  # Salir de la función sin instalar el flujo
    ...
    def _packet_in_handler(self, ev):
        ...
        self.logger.info(f"Paquete procesado en switch {dpid}. De {src} a {dst}, puerto de salida: {out_port}")
