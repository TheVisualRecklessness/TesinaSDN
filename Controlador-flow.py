...
class CombinedController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mac_to_port = {}
        self.flow_counter = defaultdict(int)  # Contador para flujos por switch
    ...
    def _packet_in_handler(self, ev):
        ...
        self.logger.info(f"Packet processed in switch {dpid}. From {src} to {dst}, output port: {out_port}")
